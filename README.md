...
5. 切到抽奖屏后点「开始抽奖」滚动（仅抽奖屏可点开始；参与/奖品/中奖屏该按钮置灰）。点「停」开奖；约 1 秒内停到中奖人并高亮，再停留约 3 秒。同一奖未抽满则继续开始/停；抽满后自动进中奖公示（上方仍是刚抽完这一奖），控制条当前奖变为下一个未抽完的奖。再切到抽奖屏即可抽下一奖，不必改下拉框。全部抽完后按钮为「已抽取」。
