...
5. 在奖品页或抽奖页点「开始抽奖」滚动（参与页该按钮置灰。同一奖未抽满时，提前进入中奖页也可开始。一奖抽满后的中奖页公示刚抽完的奖、下拉框已是下一奖，此时开始按钮仍置灰，须先切到奖品页或抽奖页再开下一奖）。滚动名单为尚未中奖的人。点「停」开奖；约 40ms 内停到中奖人并高亮，再停留约 3 秒（此期间下拉框和抽奖屏仍是刚抽的这一奖）。同一奖未抽满则继续开始/停；抽满后自动进中奖公示（上方仍是刚抽完这一奖），这时控制条当前奖才变为下一个未抽完的奖。再切到奖品页或抽奖页即可抽下一奖。全部抽完后按钮为「已抽取」。
